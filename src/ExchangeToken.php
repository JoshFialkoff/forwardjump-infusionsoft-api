...
class ExchangeToken extends \Infusionsoft\Infusionsoft {

	public function __construct() {
		$infusionsoft = new \Infusionsoft\Infusionsoft( array(
			'clientId'     => Init::get_client_id(),
			'clientSecret' => Init::get_client_secret(),
			'redirectUri'  => admin_url(),
		) );
	}

	public function request_access_token( $infusionsoft, $infusionsoft_token ) {
